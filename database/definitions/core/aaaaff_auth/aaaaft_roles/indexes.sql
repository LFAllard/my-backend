-- database/definitions/core/aaaaff_auth/aaaaft_user_roles/indexes.sql
...
CREATE INDEX IF NOT EXISTS "idx_aaaaft_user_roles_role_key" 
ON aaaaft_user_roles(role_key);
