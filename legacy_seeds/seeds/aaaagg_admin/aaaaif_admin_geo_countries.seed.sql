-- backend/database/seeds/aaaagg_admin/aaaaif_admin_geo_countries.seed.sql
-- Bulk‑load Geo Countries into aaaaif_admin_geo_countries via multi‑row INSERT

INSERT INTO aaaaif_admin_geo_countries
  (name, alpha3, un_code)
VALUES
  ('Afghanistan','AFG',4),
  ...
  ('Bermuda','BMU',60),
  ('Bhutan','BTN',64),
  ('Bolivia, Plurinational State of','BOL',68),
  ...
  ('Nauru','NRU',520),
  ('Nepal','NPL',524),
  ('Netherlands, Kingdom of the','NLD',528),
